...
| T-N | 求职证据增强：真实模型评测、决策依据展示、评测可视化与面试材料 | Codex | 待复核 | T-L | 决策摘要、知识来源汇总、真实工具计数、评测指标卡与面试材料已完成；47 passed / 3 skipped，前端构建通过；DeepSeek 全量 100/100 成功执行，意图 85/100、工具 2/9、转人工 2/5、拒答/拦截 2/6，报告 `eval-20260910044705`；原 24 条切片仅保留为小样本历史 |
